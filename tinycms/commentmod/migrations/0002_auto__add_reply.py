...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reply'
        db.create_table(u'commentmod_reply', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['commentmod.CommentMod'])),
            ('show_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('reply', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'commentmod', ['Reply'])


    def backwards(self, orm):
        # Deleting model 'Reply'
        db.delete_table(u'commentmod_reply')
    ...
    models = {
        ...
        u'commentmod.reply': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['commentmod.CommentMod']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
