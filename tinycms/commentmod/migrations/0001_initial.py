...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentMod'
        db.create_table(u'commentmod_commentmod', (
        ...
        db.send_create_signal(u'commentmod', ['CommentMod'])


    def backwards(self, orm):
        # Deleting model 'CommentMod'
        db.delete_table(u'commentmod_commentmod')
