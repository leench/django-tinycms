...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Advertising', fields ['identifier']
        db.create_unique(u'advertising_advertising', ['identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'Advertising', fields ['identifier']
        db.delete_unique(u'advertising_advertising', ['identifier'])
