...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Link'
        db.create_table(u'tinycms_link', (
            ...
            ('order', self.gf('django.db.models.fields.IntegerField')(default=20)),
        ))
        db.send_create_signal(u'tinycms', ['Link'])


    def backwards(self, orm):
        # Deleting model 'Link'
        db.delete_table(u'tinycms_link')
    ...
    models = {
        ...
        u'tinycms.entrybase': {
            ...
            'symbol': ('django.db.models.fields.related.ManyToManyField', [], {'default': "u'index'", 'to': u"orm['tinycms.Symbol']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
            'template': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
