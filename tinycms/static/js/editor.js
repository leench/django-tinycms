$(document).ready(function() {
	$('textarea#id_content').tinymce({
		...
		*/
		...
		// Theme options
		theme_advanced_buttons1 : "mediaupload,save,newdocument,code,|,bold,italic,underline,strikethrough,|,forecolor,backcolor,|,justifyleft,justifycenter,justifyright,justifyfull,styleselect,formatselect,fontselect,fontsizeselect",
